...
class Forklift(object):
    ...
    def __init__(self, bot):
        ...
        self._rotate_motor = CalibratedMotor(bot, CalibratedMotor._bp.PORT_C, calpow=70)
        self._height_motor = CalibratedMotor(bot, CalibratedMotor._bp.PORT_A, calpow=40)
